...
for i in range(0, 340):
	total = grid[i]*grid[i+20]*grid[i+40]+grid[i+60]
    if (total>greatest):
	    greatest = total
...
for i in range (0,400):
    if (i%20<16):
        total = grid[i]*grid[i+1]*grid[i+2]*grid[i+3]
        if (total>greatest):
            greatest = total
...
for i in range (0,337):
    if (i%20<16):
        total = grid[i]*grid[i+21]*grid[i+42]*grid[i+63]
        if (total>greatest):
            greatest = total
...
for i in range (60,400):
    if (i%20<16):
        total = grid[i]*grid[i-19]*grid[i-38]*grid[i-57]
        if (total>greatest):
            greatest = total
